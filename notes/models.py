...
class Diary(models.Model):
  user = models.OneToOneField(Account, related_name='diary', on_delete=models.CASCADE)
...
class NoteBook(models.Model):
  user = models.ForeignKey(Account, related_name='notebooks', on_delete=models.CASCADE)
...
class StickyNote(models.Model):
  user = models.ForeignKey(Account, related_name='sticky_notes', on_delete=models.CASCADE)
  text = models.TextField()
...
class SharedNote(models.Model):
  note = models.ForeignKey(Note, on_delete=models.CASCADE)
  sender = models.ForeignKey(Account, related_name='sent_notes', on_delete=models.CASCADE)
  receiver = models.ForeignKey(Account, related_name='received_notes', on_delete=models.CASCADE)
  date_shared = models.DateTimeField(auto_now_add=True)

  # namra.sent_notes.all() all notes sent by namra  
  # namra.received_notes.all() all notes received by namra

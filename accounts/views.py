...
def login_view(request):
  ...
  if request.method == 'POST':
    ...
    if form.is_valid():
      ...
      login(request, user)
      return redirect('notes:dashboard') if not next_url else redirect(next_url)
...
def check_username_validity(request):
  ...
  # This view gets executed when user focuses out of username field
  # in the signupform
  if request.is_ajax and request.method == 'POST':
    ...
    return JsonResponse({'message': 'Username free to use', 'class': 'success'})
